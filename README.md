...
- **Layout/stride semantics:** tensors are expected to be contiguous; strided layouts are validated against storage span requirements and rejected with explicit `LayoutError` diagnostics in Rust and Python bindings (see `docs/tensor_layout.md`).
